...
$(".menu1").click(function(){
    $(".hidebox1").slideToggle(400,"swing",function(){})
});
$(".menu2").click(function(){
    $(".hidebox2").slideToggle(400,"swing",function(){})
});
$(".menu3").click(function(){
    $(".hidebox3").slideToggle(400,"swing",function(){})
});


$(".hidemenu").hide();
$(".Collapse_menu").click(function(){
    $(".hidemenu").slideToggle(400,"linear",function(){})
});